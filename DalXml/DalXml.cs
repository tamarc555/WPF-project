...
namespace Dal
{
    sealed class DalXml : IDal
    {
        ...
        //    listOfAllCustomers.ForEach(delegate (DalApi.DO.Customer c) { if (tempCustomer.ID == c.ID) throw new IDexists("ID already exists\n"); });
        //    listOfAllCustomers.Add(tempCustomer);
        //    XMLTools.SaveListToXMLSerializer<Customer>(listOfAllCustomers, customerArray);
        //}
        ...
        //    List<Customer> listOfAllCustomers = XMLTools.LoadListFromXMLSerializer<Customer>(customerArray);
        //    int customerIndex = listOfAllCustomers.FindIndex(x => x.ID == tempCustomerID);
        //        if (customerIndex == -1) throw new IDdoesntExists("this customer doesn't exist\n");
        //        for (int i = 0; i < listOfAllParcels.Count; i++)
        //            if (listOfAllParcels[i].TargetID == tempCustomerID && listOfAllParcels[i].Delivered == null)
        //                throw new DeleteProblemException("there is a parcel on the way for this customer\n");
        //    listOfAllCustomers.RemoveAt(customerIndex);
        //    XMLTools.SaveListToXMLSerializer<Customer>(listOfAllCustomers, customerArray);
        ...
        //    for (int i = 0; i < listOfAllCustomers.Count; i++)
        //    {
        //        if (tempCustomer.ID == listOfAllCustomers[i].ID)
        //        {
        //            listOfAllCustomers.Remove(listOfAllCustomers[i]);
        //            listOfAllCustomers.Add(tempCustomer);
        //            break;
        //        }
        //    }
        ...
        //{
        //    List<Customer> listOfAllCustomers = XMLTools.LoadListFromXMLSerializer<Customer>(customerArray);
        //    int CustomerIndex = listOfAllCustomers.FindIndex(x => x.ID == myID);
        //    if (!(CustomerIndex >= 0 && CustomerIndex <= listOfAllCustomers.Count)) throw new IDdoesntExists("the customer doesnt exists\n");
        //    DalApi.DO.Customer tempCustomer = listOfAllCustomers.Find(x => x.ID == myID);
        //    XMLTools.SaveListToXMLSerializer<Customer>(listOfAllCustomers, customerArray);
        //    return tempCustomer;
        //}
        [MethodImpl(MethodImplOptions.Synchronized)]
        ...
        //    var list = (from customer in listOfAllCustomers
        //                select customer).ToList();
        //    return list;
        //}
